...
from tkinter import filedialog # submodule 이라 따로 import 해야 함.
...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요.", \
        ...
        initialdir = r"D:\study") # 최초에 사용자가 지정한 경로를 보여줌
...
def merge_image():
    ...
    dest_path = os.path.join(txt_dest_path.get(), "sm_photo.jpg")
