...
# 화면 타이틀 설정
pygame.display.set_caption("Suman Game") # 게임 이름

# FPS
clock = pygame.time.Clock()

# 배경이미지 불러오기
background = pygame.image.load("PYTHONWORKSPACE/pygame_basic/background.png")

# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("PYTHONWORKSPACE/pygame_basic/character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("PYTHONWORKSPACE/pygame_basic/enemy.png")
...
while running:
    dt = clock.tick(288) # 게임화면의 초당 프레임 수를 설정
